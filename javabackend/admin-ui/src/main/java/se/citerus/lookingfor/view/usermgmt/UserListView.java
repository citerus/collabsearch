...
public class UserListView extends CustomComponent {
	...
	public UserListView(final ViewSwitchListener listener) {
		...
		addButton.addListener(new ClickListener() {
			public void buttonClick(ClickEvent event) {
				listener.switchToUserMgmtView(null);
			}
		});
		editButton.addListener(new ClickListener() {
			public void buttonClick(ClickEvent event) {
				...
				if (selectedUser == null) {
					...
					listener.switchToUserMgmtView(selectedUser);
				}
			}
		});
		deleteButton.addListener(new ClickListener() {
			public void buttonClick(ClickEvent event) {
				...
				if (selectedUser == null) {
					...
					//TODO remove user from DB, update table
				}
			}
		});
		...
		userTable.addListener(new ItemClickListener() {
			public void itemClick(ItemClickEvent event) {
				//System.out.println("userTable.ItemClickListener: " + event.getPropertyId());
			}
		});
		userTable.addListener(new Property.ValueChangeListener() {
			public void valueChange(ValueChangeEvent event) {
				System.out.println("userTable.ValueChangeListener: " + event.getProperty().getValue());
			}
		});
	...
	private void populateUserTable() {
		...
		final List<User> listOfUsers = userHandler.getListOfUsers();
		
		BeanContainer<String, User> userContainer = new BeanContainer<String, User>(User.class);
		userContainer.setBeanIdProperty("username");
		
		userContainer.addAll(listOfUsers);
		userTable.setContainerDataSource(userContainer);
		userTable.setVisibleColumns(new Object[]{"username","role"});
	}
